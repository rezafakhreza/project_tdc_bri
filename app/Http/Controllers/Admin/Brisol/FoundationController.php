...
use App\Imports\Brisol\FoundationImport;
...
class FoundationController extends Controller
{
    public function index()
    {
        if (request()->ajax()) {
            ...
            return DataTables::of($query)
                ->addColumn('action', function ($foundation) {
                    return '
                        ...
                        <a class="block w-full px-2 py-1 mb-1 text-xs text-center text-white transition duration-500 bg-gray-700 border border-gray-700 rounded-md select-none btn-edit ease hover:bg-gray-800 focus:outline-none focus:shadow-outline"
                            href="' . route('admin.brisol.foundation.edit', $foundation->id) . '">
                        ...
                        <form class="block w-full" action="' . route('admin.brisol.foundation.destroy', $foundation->id) . '" method="POST">
        ...
        return view('admin.brisol.foundation.index');
    }
    ...
    {
        return view('admin.brisol.foundation.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->input_method == 'excel') {
            ...
            return redirect()->route('admin.brisol.foundation.index')
                ->with('success', 'Foundation created successfully');
        }
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.brisol.foundation.edit', compact('foundation'));
    }
    ...
    public function update(Request $request, string $id)
    {
        // Validasi input
        $request->validate([
            'buss_service' => 'required|string|max:255',
        ...
        // Update data cabang
        $foundation->update([
            'buss_service' => $request->buss_service,
        ...
        return redirect()->route('admin.brisol.foundation.index')->with('success', 'Foundation updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.brisol.foundation.index')
            ->with('success', 'Foundation deleted successfully');
    }
}
