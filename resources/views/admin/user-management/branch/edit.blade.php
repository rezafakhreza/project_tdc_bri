  ...
  <div class="py-12 font-poppins">
    ...
    <div class="p-6 bg-white rounded-md">
        ...
        <div>
          ...
          @endif
          <form class="w-full" action="{{ route('admin.user-management.branch.update', $branch->branch_code) }}" method="post"
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <input value="{{ old('name') ?? $branch->branch_name }}" name="name"
                       class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                       id="branch_name" type="text" placeholder="Nama Branch">
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              <div class="w-full">
                ...
                <input value="{{ old('name') ?? $branch->kanwil_name }}" name="name"
                       class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                       id="kanwil_name" type="text" placeholder="Nama Kanwil">
                <div class="mt-2 text-sm text-gray-500">
                  <!-- Nama modul deployment. Contoh: Module 1, Module 2, dsb. -->
                </div>
              </div>
