            ...
            <div class="p-6 bg-white rounded-lg">
                ...
                <form action="{{ route('admin.background-jobs-monitoring.jobs.store') }}" method="post" class="w-full">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <select id="status" name="status"
                                    ...
                                    <option value="Normal Run" {{ old('status') == 'Normal Run' ? 'selected' : '' }}>
                                        Normal Run</option>
                                    <option value="Rerun Background Job"
                                        {{ old('status') == 'Rerun Background Job' ? 'selected' : '' }}>Rerun Background
                                        Job</option>
                                    <option value="Manual Run Background Job"
                                        {{ old('status') == 'Manual Run Background Job' ? 'selected' : '' }}>Manual Run
                    ...
                    <div class="text-right">
                        <button type="submit"
                            class="px-4 py-2 font-bold text-white rounded shadow-lg bg-darker-blue">Add Background
                            Job</button>
                    </div>
                </form>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                $('#process_id').append('<option value="' + value.id +
                                    '">' + value.name + '</option>');
                            });
                        }
                    });
