    ...
    <x-slot name="script">
        <script>
            ...
            var datatable = $('#dataTable').DataTable({
                ...
                stateSave: false,
                ajax: {
                    url: '{{ route('admin.brisol.foundation-fam.index') }}',
                    type: 'GET',
                },
                language: {
                ...
                columns: [{
                        data: 'buss_service_fam',
                        name: 'buss_service_fam',
                        searchable: true,
                    },
                    {
                        data: 'prd_tier1',
                                            ...
                                            <div class="sm:flex sm:items-start">
                                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        @endif
                                                        <form id="uploadForm" action="{{ route('admin.brisol.foundation-fam.store') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="mb-3">
