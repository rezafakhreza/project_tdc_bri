        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="p-6 bg-white rounded-md">
                ...
                <div>
                    ...
                    @endif
                    <form class="w-full" action="{{ route('admin.brisol.foundation.update', $foundation->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="prd_tier1" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white" id="prd_tier1" required>
                                        <option value="" disabled {{ old('prd_tier1', $foundation->prd_tier1) ? '' : 'selected'}}>Product Categorization Tier 1</option>
                                        <option value="SAP" {{ old('prd_tier1', $foundation->prd_tier1) === 'SAP' ? 'selected' : ''}}>SAP</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="prd_tier2" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white" id="prd_tier2" required>
                                        <option value="" disabled {{ old('prd_tier2', $foundation->prd_tier2) ? '' : 'selected'}}>Product Categorization Tier 2</option>
                                        <option value="AA" {{ old('prd_tier2', $foundation->prd_tier2) === 'AA' ? 'selected' : ''}}>AA</option>
                                        <option value="AP" {{ old('prd_tier2', $foundation->prd_tier2) === 'AP' ? 'selected' : ''}}>AP</option>
                                        <option value="BC" {{ old('prd_tier2', $foundation->prd_tier2) === 'BC' ? 'selected' : ''}}>BC</option>
                                        <option value="GR" {{ old('prd_tier2', $foundation->prd_tier2) === 'GR' ? 'selected' : ''}}>GR</option>
                                        <option value="MM" {{ old('prd_tier2', $foundation->prd_tier2) === 'MM' ? 'selected' : ''}}>MM</option>
                                        <option value="RE-FX" {{ old('prd_tier2', $foundation->prd_tier2) === 'RE-FX' ? 'selected' : ''}}>RE-FX</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="prd_tier3" class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white" id="prd_tier3" required>
                                        <option value="" disabled {{ old('prd_tier3', $foundation->prd_tier3) ? '' : 'selected'}}>Product Categorization Tier 3</option>
                                        <option value="Asset Movement" {{ old('prd_tier3', $foundation->prd_tier3) === 'Asset Movement' ? 'selected' : ''}}>Asset Movement</option>
                                        <option value="Asset Procurement & DIstribution" {{ old('prd_tier3', $foundation->prd_tier3) === 'Asset Procurement & DIstribution' ? 'selected' : ''}}>Asset Procurement & DIstribution</option>
                                        <option value="End of Periodic Processing" {{ old('prd_tier3', $foundation->prd_tier3) === 'End of Periodic Processing' ? 'selected' : ''}}>End of Periodic Processing</option>
                                        <option value="Group Reporting Processing" {{ old('prd_tier3', $foundation->prd_tier3) === 'Group Reporting Processing' ? 'selected' : ''}}>Group Reporting Processing</option>
                                        <option value="Master Data" {{ old('prd_tier3', $foundation->prd_tier3) === 'Master Data' ? 'selected' : ''}}>Master Data</option>
                                        <option value="PSAK-73" {{ old('prd_tier3', $foundation->prd_tier3) === 'PSAK-73' ? 'selected' : ''}}>PSAK-73</option>
                                        <option value="User Access" {{ old('prd_tier3', $foundation->prd_tier3) === 'User Access' ? 'selected' : ''}}>User Access</option>
