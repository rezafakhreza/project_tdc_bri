    ...
    <x-slot name="script">
        <script>
            ...
            var datatable = $('#dataTable').DataTable({
                ...
                stateSave: false,
                ajax: {
                    url: '{{ route('admin.brisol.foundation-iem.index') }}',
                    type: 'GET',
                },
                language: {
                ...
                columns: [{
                        data: 'buss_service_iem',
                        name: 'buss_service_iem',
                        searchable: true,
                    },
                    {
                        data: 'prd_tier1',
        ...
        <script>
            function downloadTemplate() {
                var templateUrl = '{{ asset('TemplateExcel/Template_Foundation_IEM.xlsx') }}';
                var link = document.createElement('a');
                link.href = templateUrl;
                link.download = 'Template_Foundation_IEM.xlsx';
                link.click();
            }
        </script>
                                            ...
                                            <div class="sm:flex sm:items-start">
                                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        @endif
                                                        <form id="uploadForm" action="{{ route('admin.brisol.foundation-iem.store') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="mb-3">
