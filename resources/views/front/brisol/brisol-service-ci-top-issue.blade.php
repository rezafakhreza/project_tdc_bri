...
@section('script')
    <script>
        ...
        function loadOverallTopIssuesChart(year = document.getElementById('yearFilter').value, month = document
            .getElementById('monthFilter').value) {
                    ...
                    currentOverallChart = new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                data: counts,
                                backgroundColor: ['#FFC107', '#FB4141', '#2ECC71', '#FF8333', '#6C97DF',
                                    '#D3D3D3'
                                ],
