...
@section('content')
            ...
            <div class="p-4 overflow-hidden bg-white shadow-xl sm:rounded-lg">
                <div class="flex justify-between p-6 mb-4 bg-white rounded shadow calendar-filter">
                    <form id="calendarFilterForm" class="flex flex-wrap items-center">
                        ...
                        <button type="submit"
                            class="px-6 py-2 text-white rounded bg-darker-blue focus:outline-none focus:ring-2 focus:ring-blue-200">
                            Filter
                        </button>
                    </form>
    ...
    <div id="eventInfoModal" class="fixed inset-0 z-50 items-center justify-center hidden">
        <div class="relative w-1/3 p-8 bg-white rounded-lg shadow-lg"> <!-- Added "relative" class -->
            ...
            <button type="button" class="absolute p-2 text-4xl text-gray-800 rounded top-2 right-4"
                id="modalCloseButton">X</button> <!-- Moved the button and added "absolute top-2 right-2" classes -->
